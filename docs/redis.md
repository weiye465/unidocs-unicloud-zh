...
> 使用腾讯云node12及以上版本和redis，务必仔细阅读此文档：[keepRunningAfterReturn](cf-functions.md?id=keep-running)
...
> 支付宝云不支持keys命令，请使用[scan](https://doc.dcloud.net.cn/uniCloud/redis.html#scan)代替
