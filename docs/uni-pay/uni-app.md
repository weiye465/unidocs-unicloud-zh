...
1. 当前不支持华为APP支付，只支持华为鸿蒙元服务应用内发起华为支付
2. 运行华为元服务的教程请查看 [鸿蒙元服务专题](https://uniapp.dcloud.net.cn/tutorial/mp-harmony/intro.html)
3. 使用华为支付时，证书必须是手动申请的证书，开发调试申请调试证书，正式发行申请正式证书，不能使用DevEco Studio自动生成的证书
4. 鸿蒙元服务和微信小程序类似，需要配置域名白名单，在开发模式下，可以进入手机【设置】-【系统】-【开发者选项】-【开发中元服务豁免管控】这个开关打开，就等于小程序里的忽略域名权限校验，正式上线时，需要
5. 如果是元服务支付，则需要在manifest.json里需要配置鸿蒙元服务的包名

![](https://web-ext-storage.dcloud.net.cn/unicloud/6714deb1-a0ab-487f-b121-7ade764ee86b.png)
