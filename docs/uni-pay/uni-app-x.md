...
![](https://web-ext-storage.dcloud.net.cn/unicloud/uni-pay-x/006603df-03c4-4da7-941e-275fae046bf4.png)
...
### 苹果虚拟支付@tips-appleiap

1. 苹果虚拟支付需勾选App模块配置中的Apple应用内支付
2. 需要打ios自定义基座
...
#### 苹果虚拟支付@get-config-help-appleiap

[苹果虚拟支付配置和证书生成教程](https://docs.qq.com/doc/DWURUVVlKUmNiV0VM)
