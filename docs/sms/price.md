...
注意：
- 资源包自购买之日起1年内有效，过期销毁资源，不支持延期和退款，建议根据业务情况，选择合适的资源包。
- 若您的业务，年短信消耗量超过100万条，欢迎发邮件到 service@dcloud.io，洽谈更优惠的定制套餐。

## 按量计费
- 短信费用为：0.036元/条。请以uniCloud控制台页面所显示的价格为准。实际价格可能会根据市场情况发生变化，我们将在价格调整前发布公告，提前通知用户。
