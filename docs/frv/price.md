...
|规格（次数）		|有效期|价格（元）	|相对按量计费单价(元/次)|
|--					|--		|--			|--						|
|500  #{rowspan=2}	|3个月	|400		|0.80					|
| 6个月				|415	|0.83		|
|1000 #{rowspan=2}	|3个月	|750		|0.75					|
| 6个月				|800	|0.8		|
|2000 #{rowspan=2}	|3个月	|1400		|0.7					|
| 6个月				|1500	|0.75		|
|5000 #{rowspan=2}	|3个月	|3250		|0.65					|
| 6个月				|3500	|0.7		|
|1万  #{rowspan=2}	|3个月	|6000		|0.6					|
| 6个月				|6500	|0.65		|
|2万  #{rowspan=2}	|3个月	|10800		|0.54					|
| 6个月				|12000	|0.6		|
|5万  #{rowspan=2}	|3个月	|23500		|0.47					|
| 6个月				|27500	|0.55		|

注意：资源包购买成功后立即生效，过期销毁资源，不支持延期和退款，建议根据业务情况，选择合适的资源包。

- uni实人认证**比云厂商的流量包便宜（均以6个月有效期为例）**：
	* 1万次流量包：购买阿里云资源包需8000元；购买腾讯云资源包需11000元；uni实人认证为6500元，价格不到腾讯云的6折。
	* 5万次流量包：购买阿里云资源包需要37500元，uni实人流量包为27500元，比阿里云便宜1万元；

另外，如果您的App调用uni实人认证，承诺半年内消耗10万次，欢迎[点此](https://im.dcloud.net.cn/#/?business_type=wholesale)沟通特价折扣。
...
- uni实人认证经常进行优惠促销活动，比如：新人福利、限时促销等，见下方`优惠福利`章节。
- 如果您的App调用uni实人认证，承诺半年内消耗10万次，欢迎[点此](https://im.dcloud.net.cn/#/?business_type=wholesale)沟通特价折扣。
- 如果您是外包厂商，或者希望作为渠道商代销uni实人认证产品，欢迎[点此](https://im.dcloud.net.cn/#/?business_type=wholesale)洽谈
