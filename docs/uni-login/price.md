...
|--					|--		|--			|--						|
|1万   #{rowspan=2}	|3个月	|285		|0.0285					|
| 6个月				|290	|0.029		|
|2万   #{rowspan=2}	|3个月	|560		|0.028					|
| 6个月				|570	|0.0285		|
|5万   #{rowspan=2}	|3个月	|1375		|0.0275					|
| 6个月				|1400	|0.028		|
|10万  #{rowspan=2}	|3个月	|2700		|0.027					|
| 6个月				|2750	|0.0275		|
|20万  #{rowspan=2}	|3个月	|5300		|0.0265					|
| 6个月				|5400	|0.027		|
|50万  #{rowspan=2}	|3个月	|12950		|0.0259					|
| 6个月				|13250	|0.0265		|
|100万 #{rowspan=2}	|3个月	|25200		|0.0252					|
| 6个月				|26000	|0.026		|
|200万 #{rowspan=2}	|3个月	|48800		|0.0244					|
| 6个月				|51000	|0.0255		|
|500万 #{rowspan=2}	|3个月	|117500		|0.0235					|
| 6个月				|125000	|0.025		|
...
## 按量计费
- 一键登录费用为：0.03元/次。请以uniCloud控制台页面所显示的价格为准。实际价格可能会根据市场情况发生变化，我们将在价格调整前发布公告，提前通知用户。



## 配套uniCloud成本

uni一键登录在实际使用中需要依赖`uniCloud`云服务，这方面费用如下：在使用阿里云正式版后，每次一键登陆请求大约需要消耗uniCloud费用0.0000139元，几乎可以忽略不计。也可以粗略认为每次使用一键登陆的成本为0.0300139元/次。费用计算规则如下：
