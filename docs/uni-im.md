> 本文为uni-im v2.x 的文档，如果旧项目需要继续使用老版本的uni-im v1.x，另见：[https://gitcode.net/dcloud/hello-uni-im/-/blob/main/README](https://gitcode.net/dcloud/hello-uni-im/-/blob/main/README)
